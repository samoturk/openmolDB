...
class Molecule(models.Model):
    ...
    #platebarcode = models.CharField(max_length=30, verbose_name='Plate barcode') #TODO
    #samplebarcode = models.CharField(max_length=30, verbose_name='Sample barcode') #TODO
